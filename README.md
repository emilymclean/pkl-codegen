...
Current builds are created for pkl version 0.29.0, 0.29.1, 0.30.0, 0.30.1, 0.30.2, 0.31.0, 0.31.1 and 0.32.0.
...
So, for Kotlin using pkl version 0.32.0:

```sh
docker run --rm -v "./:/data" ghcr.io/emilymclean/pkl-codegen-kotlin:0.32.0 /data/example.pkl -o /data/java
```
